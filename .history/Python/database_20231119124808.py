...
col2=[rd.choice(list(range(5))) for _ in range(data_count)]
col3=[rd.choice(list(range(20))) for _ in range(data_count)]
col4=[rd.choice(list(range(50))) for _ in range(data_count)]
col5=[rd.choice(list(range(100))) for _ in range(data_count)]
col6=[i+rd.choice(list(range(3))) for _ in range(data_count)]
